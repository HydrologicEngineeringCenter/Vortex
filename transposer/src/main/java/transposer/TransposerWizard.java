...
public class TransposerWizard extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent p = FXMLLoader.load( TransposerWizard.class.getResource("/fxml/Wizard.fxml"),
                null,
        ...
        primaryStage.setTitle("Transposer Wizard");
