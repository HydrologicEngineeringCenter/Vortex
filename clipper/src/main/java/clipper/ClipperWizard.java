...
public class ClipperWizard extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent p = FXMLLoader.load( ClipperWizard.class.getResource("/fxml/Wizard.fxml"),
                null,
        ...
        primaryStage.setTitle("Clipper Wizard");
