...
public class WizardController {
    ...
    private static final String CONTROLLER_KEY = "dssPathnamePartsController";
    ...
    private void buildSteps() throws java.io.IOException {
        ...
        FXMLLoader fxmlLoaderStep2 = new FXMLLoader( WizardController.class.getResource("/fxml/GeoprocessingStep.fxml"), null, bf, cb );
