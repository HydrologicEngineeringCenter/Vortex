...
public class ViewSwitcher {
    ...
    public void switchView(Stage stage) {
        ...
        Preferences pref = Preferences.userNodeForPackage(TravelLengthGridCellsExporterWizard.class);
        ...
        stage.setOnCloseRequest((final WindowEvent event) -> {
            Preferences preferences = Preferences.userNodeForPackage(TravelLengthGridCellsExporterWizard.class);
