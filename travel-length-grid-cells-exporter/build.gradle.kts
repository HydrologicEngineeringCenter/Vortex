...
base.archivesBaseName = "travel-length-grid-cells-exporter"
...
tasks.jar {
    ...
    manifest {
        attributes(
                "Main-Class" to "exporter.TravelLengthGridCellsExporterWizard",
                "Class-Path" to "./lib/*"
        )
    }
}
...
application {
    mainClassName = "exporter.TravelLengthGridCellsExporterWizard"
