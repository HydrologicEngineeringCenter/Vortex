...
public class CalculatorWizard extends JFrame {
    ...
    private JPanel stepOneSourceFilePanel() {
        ...
        JLabel selectSourceFileLabel = new JLabel(TextProperties.getInstance().getProperty("CalculatorWiz_SelectSourceFile_L"));
    ...
    private JPanel stepOneSourceGridsPanel() {
        ...
        JLabel selectSourceGridsLabel = new JLabel(TextProperties.getInstance().getProperty("CalculatorWiz_SelectSourceGrids_L"));
