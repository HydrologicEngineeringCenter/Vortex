...
export DYLD_LIBRARY_PATH="../bin/gdal"
export DYLD_FALLBACK_LIBRARY_PATH="@loader_path"
export GDAL_DATA="../bin/gdal-data"
export PROJ_LIB="../bin/proj-db"

JAVA_PATH="../jre/Contents/Home/bin/java"
JAVA_LIB_PATH="../bin/gdal:../bin/javaHeclib"
