...
public class WizardController {
    ...
    private static final String CONTROLLER_KEY = "dssController";
    ...
    private void buildSteps() throws java.io.IOException {
        ...
        FXMLLoader fxmlLoaderStep4 = new FXMLLoader(WizardController.class.getResource("/fxml/Step4.fxml"), null, bf, cb );
