...
base.archivesBaseName = "normalizer"
...
tasks.jar {
    ...
    manifest {
        attributes(
                "Main-Class" to "normalizer.NormalizerWizard",
                "Class-Path" to "./lib/*"
        )
    }
}
...
application {
    ...
    applicationDefaultJvmArgs = listOf("-Djava.library.path=${rootProject.projectDir}/bin/gdal")
}
