...
C:\jython2.7.2\bin\jython.exe -J-Xmx10g -Djava.library.path=%VORTEX_HOME%\bin;%VORTEX_HOME%\bin\gdal C:\workspace\git_clones\vortex_scripting\UA_to_DSS_IMPORT\filter_no_data.py
cmd /k