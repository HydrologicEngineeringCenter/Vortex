...
public class CalculatorWizard extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent p = FXMLLoader.load( CalculatorWizard.class.getResource("/fxml/Wizard.fxml"),
                null,
        ...
        primaryStage.setTitle("Calculator Wizard");
