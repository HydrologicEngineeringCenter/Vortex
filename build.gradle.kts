...
tasks.register<Copy>("getNatives") {
    ...
    doLast {
        ...
        // No macOS branch: the javaHeclib archive bundles libgcc_s, libquadmath
        // and libgfortran alongside the Heclib native and links against the
        // versioned names it ships, so it resolves without any fixup here.
    }
}
