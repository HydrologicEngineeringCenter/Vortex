...
public class TimeConverter {
    ...
    private static final Map<String, TemporalAccessor> cache = new HashMap<>();
    ...
    public static ZonedDateTime toZonedDateTime(String dateTimeString) {
        TemporalAccessor parsedDate = cache.computeIfAbsent(dateTimeString, TimeConverter::parseDate);
