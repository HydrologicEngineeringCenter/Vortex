...
public class ViewSwitcher {
    ...
    public void switchView(Stage stage) {
        ...
        Preferences pref = Preferences.userNodeForPackage(MetDataImportWizard.class);
        ...
        stage.setOnCloseRequest((final WindowEvent event) -> {
            Preferences preferences = Preferences.userNodeForPackage(MetDataImportWizard.class);
