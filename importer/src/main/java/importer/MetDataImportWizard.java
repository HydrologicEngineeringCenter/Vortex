...
public class MetDataImportWizard extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final Parent p = FXMLLoader.load( MetDataImportWizard.class.getResource("/fxml/Wizard.fxml"),
                null,
        ...
        primaryStage.setTitle("Gridded Data Import Wizard");
