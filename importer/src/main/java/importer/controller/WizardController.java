...
public class WizardController {
    ...
    private void buildSteps() throws java.io.IOException {
        ...
        FXMLLoader fxmlLoaderGeoprocessingOptionsStep = new FXMLLoader( WizardController.class.getResource("/fxml/GeoprocessingOptions.fxml"), null, bf, cb );
        Parent geoprocessingOptionsStep = fxmlLoaderGeoprocessingOptionsStep.load();
        geoprocessingOptionsStep.getProperties().put( CONTROLLER_KEY, fxmlLoaderGeoprocessingOptionsStep.getController() );
        ...
        steps.addAll( Arrays.asList(step1, step2, geoprocessingOptionsStep, step3, processing, completed));
    }
